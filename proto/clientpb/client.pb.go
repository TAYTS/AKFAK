...
var fileDescriptor_e0b4fa04edbad8e6 = []byte{
	...
	0x90, 0x7e, 0x28, 0x0b, 0x22, 0x6d, 0xf4, 0x85, 0x89, 0x8b, 0xd7, 0x19, 0x6c, 0x57, 0x70, 0x6a,
	...
	0x04, 0x77, 0x2e, 0xdc, 0xaf, 0x7a, 0x50, 0x19, 0x74, 0xe7, 0x62, 0x51, 0x80, 0xe2, 0xdc, 0x04,
	0x2e, 0x5e, 0xf7, 0xd4, 0x12, 0xc7, 0xe2, 0xe2, 0xcc, 0xf4, 0xbc, 0xdc, 0xd4, 0xbc, 0x12, 0x21,
	0x55, 0x0c, 0x8d, 0x28, 0xf2, 0x30, 0xf3, 0xd5, 0x08, 0x29, 0x83, 0xd9, 0xe2, 0x24, 0x16, 0x25,
	0xe2, 0xe8, 0xed, 0xe6, 0xe8, 0xad, 0x8f, 0x9a, 0x14, 0x92, 0xd8, 0xc0, 0x7c, 0x63, 0x40, 0x00,
	0x00, 0x00, 0xff, 0xff, 0xaf, 0x9b, 0xa7, 0x12, 0x23, 0x02, 0x00, 0x00,
}
...
type ClientServiceClient interface {
	...
	GetAssignment(ctx context.Context, in *consumepb.GetAssignmentRequest, opts ...grpc.CallOption) (*consumepb.GetAssignmentResponse, error)
}
...
func (c *clientServiceClient) GetAssignment(ctx context.Context, in *consumepb.GetAssignmentRequest, opts ...grpc.CallOption) (*consumepb.GetAssignmentResponse, error) {
	out := new(consumepb.GetAssignmentResponse)
	err := c.cc.Invoke(ctx, "/proto.clientpb.ClientService/GetAssignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClientServiceServer interface {
	...
	GetAssignment(context.Context, *consumepb.GetAssignmentRequest) (*consumepb.GetAssignmentResponse, error)
}
...
func (*UnimplementedClientServiceServer) GetAssignment(ctx context.Context, req *consumepb.GetAssignmentRequest) (*consumepb.GetAssignmentResponse, error) {
...
func _ClientService_GetAssignment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(consumepb.GetAssignmentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientServiceServer).GetAssignment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.clientpb.ClientService/GetAssignment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientServiceServer).GetAssignment(ctx, req.(*consumepb.GetAssignmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ClientService_GetAssignment_Handler,
		},
	},
